...
<div class="">
    <h4 class="center-align">Eliminar Categoria</h4>
</div>
...
<div class="col s12 ">
    <div class="card" style="background-color:#41B5C2;padding-left: 60px;padding-right: 60px; padding-bottom: 30px; margin-left: 150px; margin-right: 150px">
        <div class="card-header" style="background-color:#41B5C2">
            <h4 class="center-align" style="color: white;">Eliminar Categoria</h4>
        </div>
        <div class="card-body">
            <form action="<?php echo RUTA_URL . "/categoria/eliminar/" . $datos['id']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="descripcion" class="form-control form-control-lg" value="<?php echo $datos['descripcion'] ?>" disabled>
                </div>
                <br>
