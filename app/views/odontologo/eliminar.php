...
<div class="col s12 ">
    <div class="card" style="background-color:#41B5C2;padding-left: 60px;padding-right: 60px; padding-bottom: 30px; margin-left: 150px; margin-right: 150px">
        <div class="card-header" style="background-color:#41B5C2;">
            <h4 class="center-align" style="color: white;">Eliminar Odontologo</h4>
        </div>
        <form action="<?php echo RUTA_URL . "/odontologo/eliminar/" . $datos['id']; ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="especialidad" class="form-control form-control-lg" value="<?php echo $datos['especialidad'] ?>" disabled>
            </div>
            <div class="form-group">
