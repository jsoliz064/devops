...
<div class="col s12 ">
    <div class="card" style="background-color:#41B5C2;padding-left: 60px;padding-right: 60px;padding-bottom: 30px; margin-left: 150px; margin-right: 150px">
        <div class="card-header" style="background-color:#41B5C2;">
            <h4 class="center-align" style="color: white;">Actualizar Paciente</h4>
        </div>
        <div class="card-body">
            <form action="<?php echo RUTA_URL  . '/paciente/actualizar/' . $datos['id']; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" class="form-control form-control-lg" value="<?php echo $datos['nombre'] ?>" minlength="3" required>
                </div>
                <div class="form-group">
                    <label for="direccion" style="color: white;">Direccion: <sup>*</sup></label>
                    <input type="text" name="direccion" class="form-control form-control-lg" value="<?php echo $datos['direccion'] ?>" minlength="3" required>
                </div>
                <div class="form-group">
                    <label for="telefono" style="color: white;">Telefono: <sup>*</sup></label>
                    <input type="text" name="telefono" class="form-control form-control-lg" value="<?php echo $datos['telefono'] ?>" pattern="^[0-9]{7,8}$" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))" required>
                </div>
                <br>
